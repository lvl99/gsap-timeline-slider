// gsap-timeline-slider v0.1.1
//
// Author: Igor Dimitrijevic <igor@ground.gr>
// Distributed under MIT License
//
// Timecode additions by Matt Scheurich <matt@lvl99.com>
//
(function() {
    "use strict";
    ...
    var pt = {
      container: function(el) {
        ...
        // Timecode
        merge(this.timecode.style, this.config.timecode);
        this.el.appendChild(this.timecode);
      ...
      // Timecode
      updateTime: function () {
        var date = new Date( this.tl.time() * 1000 );
        this.timecode.innerHTML = leadingZero(date.getMinutes()) + ':' + leadingZero(date.getSeconds()) + ':' + leadingZero(Math.floor(date.getMilliseconds() / 10));
      },
      onStart: function() {
          this.toggle(false);
